                            ...
                            <tr>
                                ...
                                <td>${currentBooking.bookingStatus}
                                    <c:if test="${currentBooking.bookingStatus eq 'REGISTERED'}">
                                        <form action="${pageContext.request.contextPath}/openChangeForm.do" method="get">
                                        ...
                                        <form action="${pageContext.request.contextPath}/cancelBooking.do" method="post">
                                            <input type="hidden" name="cancelBookingId" value="${currentBooking.bookingId}"/>
                                            <input type="hidden" name="cancelInvoiceId" value="${currentBooking.invoiceId}"/>
                            ...
                            <tr>
                                ...
                                <td>${currentInvoice.invoiceStatus}
                                    <c:if test="${currentInvoice.invoiceStatus eq 'PAY_IN_HOTEL' and currentInvoice.isPayed eq 'false'}">
                                        <form action="${pageContext.request.contextPath}/payInvoice.do" method="post">
                                            <input type="hidden" value="${currentInvoice.invoiceId}" name="invoiceIdForPayment"/>
